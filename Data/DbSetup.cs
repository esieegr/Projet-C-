...
CREATE TABLE IF NOT EXISTS Echanges(
  ...
  updated_at TEXT DEFAULT (datetime('now'))
            ...
            await AddColumnIfMissingAsync(db, "Objets", "EtatObjet", "INTEGER", "1"); // 1 = Bon
...
END;");
        ...
        public static async Task SeedSampleAsync(SchoolContext db)
        {
            ...
            await ExecAsync(conn, "INSERT OR IGNORE INTO Objets(Nom) VALUES ('PC Portable');");
            await ExecAsync(conn, "INSERT OR IGNORE INTO Objets(Nom) VALUES ('Livre C#');");
